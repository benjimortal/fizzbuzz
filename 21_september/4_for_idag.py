...
class Rect:
    ...
    def draw(self):
        pygame.draw.rect(self.screen, self.color, (self.x, self.y, self.width, self.height), 0) # den fuller på färg blå
...
def main():
    ...
    while running:
        ...
        if blue_rect.collide(ball):
            ...
            #if som kollar om bollens mitpunkt är inne i rutan
            #   flytta bollen i nuvarande x_step och y_step till bollen är ute ur rutan
